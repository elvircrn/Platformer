...
namespace Platformer
{
    public class GameObject
    {
        ...
        public virtual Vector2 CollisionRectangle 
        {
        ...
        {
            get { return new Rectangle((int)WorldLocation.X, (int)WorldLocation.Y, (int)CollisionRectangle.X, (int)CollisionRectangle.Y); }
        }
